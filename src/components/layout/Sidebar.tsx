...
import {
    ...
    Lock, ShieldAlert, UserCircle2, History, LogOut, GraduationCap, BarChart3, Settings2, ActivitySquare,
} from "lucide-react"
...
const genesisNav: NavSection[] = [
    ...
    { title: "SISTEMA", items: [
        ...
        { label: "Status do Sistema", to: "/dashboard/genesis/system-status", icon: ActivitySquare },
    ]},
]
